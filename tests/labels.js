module.exports = {
    ...
    'Add and remove label' : function (browser) {
      
      browser
      .url('https://beta.protonmail.com/settings/labels')
      .waitForElementVisible('[data-test-id="folders/labels:addLabel"]', function(){
        this.click('[data-test-id="folders/labels:addLabel"]');
        })    
